...
module soc_system_mm_interconnect_0 (
		...
		input  wire        pio_out_reset_reset_bridge_in_reset_reset,                        //                        pio_out_reset_reset_bridge_in_reset.reset
	...
	wire  [129:0] pio_out_s1_agent_rf_source_data;                                                    // pio_out_s1_agent:rf_source_data -> pio_out_s1_agent_rsp_fifo:in_data
	...
	wire  [129:0] pio_out_s1_agent_rsp_fifo_out_data;                                                 // pio_out_s1_agent_rsp_fifo:out_data -> pio_out_s1_agent:rf_sink_data
	...
	wire          pio_out_s1_agent_rdata_fifo_src_valid;                                              // pio_out_s1_agent:rdata_fifo_src_valid -> pio_out_s1_agent_rdata_fifo:in_valid
	wire   [33:0] pio_out_s1_agent_rdata_fifo_src_data;                                               // pio_out_s1_agent:rdata_fifo_src_data -> pio_out_s1_agent_rdata_fifo:in_data
	wire          pio_out_s1_agent_rdata_fifo_src_ready;                                              // pio_out_s1_agent_rdata_fifo:in_ready -> pio_out_s1_agent:rdata_fifo_src_ready
	...
	wire  [129:0] pio_in_s1_agent_rf_source_data;                                                     // pio_in_s1_agent:rf_source_data -> pio_in_s1_agent_rsp_fifo:in_data
	...
	wire  [129:0] pio_in_s1_agent_rsp_fifo_out_data;                                                  // pio_in_s1_agent_rsp_fifo:out_data -> pio_in_s1_agent:rf_sink_data
	...
	wire          pio_in_s1_agent_rdata_fifo_src_valid;                                               // pio_in_s1_agent:rdata_fifo_src_valid -> pio_in_s1_agent_rdata_fifo:in_valid
	wire   [33:0] pio_in_s1_agent_rdata_fifo_src_data;                                                // pio_in_s1_agent:rdata_fifo_src_data -> pio_in_s1_agent_rdata_fifo:in_data
	wire          pio_in_s1_agent_rdata_fifo_src_ready;                                               // pio_in_s1_agent_rdata_fifo:in_ready -> pio_in_s1_agent:rdata_fifo_src_ready
	...
	wire          pio_out_s1_agent_rp_valid;                                                          // pio_out_s1_agent:rp_valid -> router_009:sink_valid
	wire  [128:0] pio_out_s1_agent_rp_data;                                                           // pio_out_s1_agent:rp_data -> router_009:sink_data
	wire          pio_out_s1_agent_rp_ready;                                                          // router_009:sink_ready -> pio_out_s1_agent:rp_ready
	wire          pio_out_s1_agent_rp_startofpacket;                                                  // pio_out_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          pio_out_s1_agent_rp_endofpacket;                                                    // pio_out_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          pio_in_s1_agent_rp_valid;                                                           // pio_in_s1_agent:rp_valid -> router_010:sink_valid
	wire  [128:0] pio_in_s1_agent_rp_data;                                                            // pio_in_s1_agent:rp_data -> router_010:sink_data
	wire          pio_in_s1_agent_rp_ready;                                                           // router_010:sink_ready -> pio_in_s1_agent:rp_ready
	wire          pio_in_s1_agent_rp_startofpacket;                                                   // pio_in_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          pio_in_s1_agent_rp_endofpacket;                                                     // pio_in_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> pio_out_s1_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> pio_out_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                              // pio_out_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> pio_out_s1_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> pio_out_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> pio_out_s1_burst_adapter:sink0_endofpacket
	wire          pio_out_s1_burst_adapter_source0_valid;                                             // pio_out_s1_burst_adapter:source0_valid -> pio_out_s1_agent:cp_valid
	wire  [128:0] pio_out_s1_burst_adapter_source0_data;                                              // pio_out_s1_burst_adapter:source0_data -> pio_out_s1_agent:cp_data
	wire          pio_out_s1_burst_adapter_source0_ready;                                             // pio_out_s1_agent:cp_ready -> pio_out_s1_burst_adapter:source0_ready
	wire    [5:0] pio_out_s1_burst_adapter_source0_channel;                                           // pio_out_s1_burst_adapter:source0_channel -> pio_out_s1_agent:cp_channel
	wire          pio_out_s1_burst_adapter_source0_startofpacket;                                     // pio_out_s1_burst_adapter:source0_startofpacket -> pio_out_s1_agent:cp_startofpacket
	wire          pio_out_s1_burst_adapter_source0_endofpacket;                                       // pio_out_s1_burst_adapter:source0_endofpacket -> pio_out_s1_agent:cp_endofpacket
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> pio_in_s1_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> pio_in_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                              // pio_in_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pio_in_s1_burst_adapter:sink0_channel
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> pio_in_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> pio_in_s1_burst_adapter:sink0_endofpacket
	wire          pio_in_s1_burst_adapter_source0_valid;                                              // pio_in_s1_burst_adapter:source0_valid -> pio_in_s1_agent:cp_valid
	wire  [128:0] pio_in_s1_burst_adapter_source0_data;                                               // pio_in_s1_burst_adapter:source0_data -> pio_in_s1_agent:cp_data
	wire          pio_in_s1_burst_adapter_source0_ready;                                              // pio_in_s1_agent:cp_ready -> pio_in_s1_burst_adapter:source0_ready
	wire    [5:0] pio_in_s1_burst_adapter_source0_channel;                                            // pio_in_s1_burst_adapter:source0_channel -> pio_in_s1_agent:cp_channel
	wire          pio_in_s1_burst_adapter_source0_startofpacket;                                      // pio_in_s1_burst_adapter:source0_startofpacket -> pio_in_s1_agent:cp_startofpacket
	wire          pio_in_s1_burst_adapter_source0_endofpacket;                                        // pio_in_s1_burst_adapter:source0_endofpacket -> pio_in_s1_agent:cp_endofpacket
	...
	wire          pio_out_s1_agent_rdata_fifo_out_valid;                                              // pio_out_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] pio_out_s1_agent_rdata_fifo_out_data;                                               // pio_out_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          pio_out_s1_agent_rdata_fifo_out_ready;                                              // avalon_st_adapter_004:in_0_ready -> pio_out_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> pio_out_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> pio_out_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                  // pio_out_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> pio_out_s1_agent:rdata_fifo_sink_error
	wire          pio_in_s1_agent_rdata_fifo_out_valid;                                               // pio_in_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] pio_in_s1_agent_rdata_fifo_out_data;                                                // pio_in_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_005:in_0_data
	wire          pio_in_s1_agent_rdata_fifo_out_ready;                                               // avalon_st_adapter_005:in_0_ready -> pio_in_s1_agent_rdata_fifo:out_ready
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                             //                      clk.clk
		.reset                  (pio_out_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (pio_out_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		...
		.cp_ready                (pio_out_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (pio_out_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (pio_out_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (pio_out_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (pio_out_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (pio_out_s1_burst_adapter_source0_channel),       //                .channel
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_out_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                             //       clk.clk
		.reset             (pio_out_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (pio_out_s1_agent_rdata_fifo_src_data),      //        in.data
		.in_valid          (pio_out_s1_agent_rdata_fifo_src_valid),     //          .valid
		.in_ready          (pio_out_s1_agent_rdata_fifo_src_ready),     //          .ready
		.out_data          (pio_out_s1_agent_rdata_fifo_out_data),      //       out.data
		.out_valid         (pio_out_s1_agent_rdata_fifo_out_valid),     //          .valid
		.out_ready         (pio_out_s1_agent_rdata_fifo_out_ready),     //          .ready
		.csr_address       (2'b00),                                     // (terminated)
		.csr_read          (1'b0),                                      // (terminated)
		.csr_write         (1'b0),                                      // (terminated)
		.csr_readdata      (),                                          // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (pio_in_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (pio_in_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (pio_in_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (pio_in_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (pio_in_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (pio_in_s1_burst_adapter_source0_channel),       //                .channel
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_in_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                             //       clk.clk
		.reset             (pio_out_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (pio_in_s1_agent_rdata_fifo_src_data),       //        in.data
		.in_valid          (pio_in_s1_agent_rdata_fifo_src_valid),      //          .valid
		.in_ready          (pio_in_s1_agent_rdata_fifo_src_ready),      //          .ready
		.out_data          (pio_in_s1_agent_rdata_fifo_out_data),       //       out.data
		.out_valid         (pio_in_s1_agent_rdata_fifo_out_valid),      //          .valid
		.out_ready         (pio_in_s1_agent_rdata_fifo_out_ready),      //          .ready
		.csr_address       (2'b00),                                     // (terminated)
		.csr_read          (1'b0),                                      // (terminated)
		.csr_write         (1'b0),                                      // (terminated)
		.csr_readdata      (),                                          // (terminated)
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) pio_out_s1_burst_adapter (
		.clk                   (clk_0_clk_clk),                                  //       cr0.clk
		.reset                 (pio_out_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
		...
		.source0_valid         (pio_out_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (pio_out_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (pio_out_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (pio_out_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (pio_out_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (pio_out_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (pio_in_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (pio_in_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (pio_in_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (pio_in_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (pio_in_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (pio_in_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_system_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                             // in_clk_0.clk
		.in_rst_0_reset (pio_out_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (pio_out_s1_agent_rdata_fifo_out_data),      //     in_0.data
		.in_0_valid     (pio_out_s1_agent_rdata_fifo_out_valid),     //         .valid
		.in_0_ready     (pio_out_s1_agent_rdata_fifo_out_ready),     //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                             // in_clk_0.clk
		.in_rst_0_reset (pio_out_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (pio_in_s1_agent_rdata_fifo_out_data),       //     in_0.data
		.in_0_valid     (pio_in_s1_agent_rdata_fifo_out_valid),      //         .valid
		.in_0_ready     (pio_in_s1_agent_rdata_fifo_out_ready),      //         .ready
